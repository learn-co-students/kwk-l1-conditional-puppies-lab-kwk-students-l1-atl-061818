def no_puppies(answer)
if answer == 0
  return "Good job, Rachel!"
else
  return "Get back to your animal goals!"
end
end # 1. Write a method called no_puppies that takes in a number of puppies as an argument. If the number of puppies is greater than zero then this method should return "No more puppies!" otherwise it should return "Well done, Rachel!"

def less_puppies(answer)
  if answer<3
    return "Good job, Rachel!"
  elsif answer == 3
